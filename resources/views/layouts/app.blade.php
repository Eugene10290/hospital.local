                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-xs-8" style="height: 100%">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <ul class="mnu">
                                @if(Auth::user())
                                    @if (Auth::user()->is_doctor == 0 || Auth::guest())
                                ...
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                       ...
                                       style="position: relative; padding-left: 50px">
                                        <img src="{{ asset('public/images/uploads/avatars/' .  Auth::user()->avatar ?? 'default.jpg' ) }}"
                                             style="width: 32px; height: 32px; position: absolute; border-radius: 50%; top:27px; left: 10px;">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        ...
                                        @if(\Entrust::can('index'))
                                            <a class="dropdown-item"
                                               href="{{ url('admin/') }}">{{ __('Админ-панель') }}</a>
                                        @endif
                                        <a class="dropdown-item" href="{{ url('/user/profile') }}">Профиль</a>
                                        <a class="dropdown-item" href="{{ url('/user/registrations/calendar') }}">Записи</a>
                                        <a class="dropdown-item" href="{{ url('/user/card') }}">Карточка</a>
                ...
                <ul class="list menu__list">
                    ...
                    @else
                        <li class="menu__group nav-item dropdown unlogin">
                            <a id="" class="nav-link dropdown-toggle unlogin-link" href="#" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }} <span class="caret"></span>
                            </a>
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <p>&#169; {{ date('Y') }} Городская Больница All rights reserved.</p>
        </div>
    </div>
</footer>
</div>
