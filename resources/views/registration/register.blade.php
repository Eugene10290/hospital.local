...
@section('content')
    <div class="wrapper container">
        <div class="doctor">
            <div class="image">
                <img src="{{ asset('public/images/uploads/avatars/'. $user[0]->avatar ?? 'default.jpg') }}">
            </div>
        ...
        <div class="create-reg">
            ...
            @if ( isset($user[0]->doctors['start_time']) ||  isset($user[0]->doctors['end_time']))
                ...
                {{ Form::close() }}
            @else
                <h3 class="btn btn-danger">Доктор ще не встановив часи роботи</h3>
            @endif
