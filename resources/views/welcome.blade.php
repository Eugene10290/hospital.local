		...
		<div id="slider" class="slider">
			...
			<div class="slider__items">
			  <div class="slider__item slider__item_active">
			    <img src="{{ asset('public/img/bg1.jpg') }}" alt="1" class="slide-img">
			  ...
			  <div class="slider__item">
			    <img src="{{ asset('public/img/bg2.jpg') }}" alt="1" class="slide-img">
			    	<div class="slide-content">
			  ...
			  <div class="slider__item">
			    <img src="{{ asset('public/img/bg3.jpg') }}" alt="1" class="slide-img">
			    	<div class="slide-content">
			    		<h3>Відділення</h3>
			...
			<div class="short-mnu">
		    	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="block-mnu1">
						<img src="{{ asset('public/img/promobox1.jpg') }}" alt="">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="block-mnu2">
						<img src="{{ asset('public/img/promobox2.jpg') }}" alt="">
						<h3>Методики</h3>
					</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			    	...
			    	<div class="block-mnu3">
			    		<img src="{{ asset('public/img/promobox3.jpg') }}" alt="">
			    		<h3>Новини</h3>
			    	</div>
					</a>
			    </div>
